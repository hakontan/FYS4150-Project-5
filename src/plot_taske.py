...
R_cm10 = np.loadtxt("datafiles/filestaske/R_cm_SunEarthJupiter.txt", skiprows=2)
...
R_cm1000 = np.loadtxt("datafiles/filestaske/R_cm_SunEarthJupiter.txt", skiprows=2)
